---
name: agendamento
description: Playbook da Alluna: marcar, remarcar e desmarcar sozinha no tipo atendimento.
matcher:
  any_keywords: [agendar, marcar, "marcar horário", massagem, drenagem, agenda, horário, remarcar, reagendar, desmarcar, cancelar]
  probe_keywords: ["que horas", "qual dia", "tem vaga", disponibilidade, quinta]
---
Neste tenant o tipo é `atendimento` (40 min). Massagem, drenagem e avaliação vão em `notes`, nunca em outro slug.
