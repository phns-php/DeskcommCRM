...
export const DICIONARIO: Traducoes = {
  ...
  "Há compromisso fora desta visão": { es: "Hay un compromiso fuera de esta vista" },
  "marcado pela IA": { es: "marcado por la IA" },
  "Ir para a data": { es: "Ir a la fecha" },
  "Ocupa horário": { es: "Ocupa horario" },
  "Recebe agendamentos do CRM": { es: "Recibe citas del CRM" },
  "Atualizar lista de agendas": { es: "Actualizar lista de agendas" },
  "Qual agenda do Google usar": { es: "Qué agenda de Google usar" },
  "Configurar agendas": { es: "Configurar agendas" },
  "Tipos e horários": { es: "Tipos y horarios" },
  ...
  "Descrição do atendimento": { es: "Descripción de la atención" },
  "Sobre o que é este atendimento?": { es: "¿De qué se trata esta atención?" },
  "Escolha quem será atendido para confirmar": { es: "Elige a quién se atenderá para confirmar" },
  "Nenhum contato encontrado": { es: "Ningún contacto encontrado" },
  "Trocar contato": { es: "Cambiar contacto" },
  "Cadastrar contato": { es: "Registrar contacto" },
  "Cadastrar e usar": { es: "Registrar y usar" },
  "Informe o nome do contato": { es: "Informa el nombre del contacto" },
  "Informe telefone ou e-mail": { es: "Informa teléfono o correo" },
  "Não consegui cadastrar o contato": { es: "No pude registrar el contacto" },
  "Detalhe do agendamento": { es: "Detalle de la cita" },
